...
El fallo típico al usar estos equipos es ignorar la impedancia de salida. El DG1022Z entrega su amplitud especificada asumiendo una carga de 50 ohmios; si conectas la salida a la entrada de alta impedancia de un osciloscopio (1 MΩ) sin ajustar la configuración de carga en el menú, verás el doble de la amplitud programada. Ese error de factor 2 confunde a mucha gente que jura que el generador está mal calibrado cuando en realidad falta un ajuste de tres segundos en el propio equipo.
