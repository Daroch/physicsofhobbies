...
La mayoría de gente comete el mismo error: usa el cargador de un móvil viejo pensando que "5V es 5V". No es así. Lo que importa es la corriente sostenida bajo carga real, no el voltaje en reposo. Un adaptador de 2.5A específico para Raspberry Pi, con cable corto y grueso, evita caídas de tensión que un cargador genérico de 1A no puede prevenir. El mismo principio decide si [una punta de soldar funde el estaño sobre un plano de tierra grande](/blog/2026-08-05-vatios-no-grados-la-fisica-real-de-una-punta-que-suelda-bien/). Igual de importante es que la carcasa tenga ventilación o contacto térmico con el chip, no solo estética.
